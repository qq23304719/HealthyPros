 ...
 */
public class RoundCornerImageView1 extends ImageView {private static final ScaleType SCALE_TYPE = ScaleType.CENTER_CROP;
    ...
    public RoundCornerImageView1(Context context, AttributeSet attrs, int defStyle) {
